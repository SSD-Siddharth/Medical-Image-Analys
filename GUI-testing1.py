...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #MainWindow.resize(1710, 600) numpy.pad
        MainWindow.numpy.pad(1710, 600)
    ...
    def get_unetmask(self):
        ...
        img1 = numpy.pad(img, (IMG_HEIGHT, IMG_WIDTH, 3), mode='constant', preserve_range=True)
        X_test[0] = img1
